  ...
  return (
    <aside className="w-full md:w-64 bg-[#1e2344] text-white p-6">
      <h1 className="text-2xl text-center font-bold mb-8">
        {userRole === "admin" ? "Admin" : "Instructor"} Dashboard Management
      </h1>
      ...
      <nav className="space-y-6">
        ...
        <div className="mt-8 border-t border-white pt-4 space-y-2">
          ...
          <div
            onClick={() =>
              navigate(`/${userRole}/courses-management/get-all-courses`)
            }
          ...
          <div
            onClick={() =>
              navigate(`/${userRole}/courses-management/create-course`)
            }
            className="hover:text-yellow-400 cursor-pointer"
          >
            ➕ Create Course
          ...
          <div
            onClick={() =>
              navigate(`/${userRole}/courses-management/delete-course`)
            }
            className="hover:text-yellow-400 cursor-pointer"
          >
            🗑️ Delete Course
