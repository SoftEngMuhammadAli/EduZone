    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-md transition-all duration-200">
          ...
          <p className="text-4xl font-bold text-blue-600">{studentsCount}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-md transition-all duration-200">
          ...
          <p className="text-4xl font-bold text-purple-600">{coursesCount}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-md transition-all duration-200">
          ...
          <p className="text-4xl font-bold text-yellow-600">{adminsCount}</p>
        </div>
      </div>
    </>
  );
